class GoalsController < ApplicationController
  ...
  private
    ...
    def goal_params
      params.require(:goal).permit(:user_id, :title, :opt_assessment, :pes_assessment, :nom_rating, :exp_duration, :pos_deviation, :act_duration)
    end
